                    ...
                    if type_configurations is not None:
                        for type_configuration in type_configurations:
                            ...
                            if mapped_module is not None:
                                ...
                                print(
                                    "duplicate_check_preference TypeConfiguration MappedModule Name : " + mapped_module.get_name())
                                print(
                                    "duplicate_check_preference TypeConfiguration MappedModule APIName : " + mapped_module.get_api_name())
                            ...
                            if field_mappings is not None:
                                for field_mapping in field_mappings:
                                    ...
                                    if current_field is not None:
                                        print(
                                            "duplicate_check_preference TypeConfiguration FieldMappings CurrentField Id : " + str(
                                                current_field.get_id()))
                                        print(
                                            "duplicate_check_preference TypeConfiguration FieldMappings CurrentField Name : " + current_field.get_name())
                                        print(
                                            "duplicate_check_preference TypeConfiguration FieldMappings CurrentField APIName : " + current_field.get_api_name())

                                    mapped_field = field_mapping.get_mapped_field()

                                    if mapped_field is not None:
                                        print(
                                            "duplicate_check_preference TypeConfiguration FieldMappings MappedField Id : " + str(
                                                mapped_field.get_id()))
                                        print(
                                            "duplicate_check_preference TypeConfiguration FieldMappings MappedField Name : " + mapped_field.get_name())
                                        print(
                                            "duplicate_check_preference TypeConfiguration FieldMappings MappedField APIName : " + mapped_field.get_api_name())
...
GetDuplicateCheckPreference.get_duplicate_check_preference(module_api_name)
