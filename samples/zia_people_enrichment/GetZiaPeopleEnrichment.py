...
from zohocrmsdk.src.com.zoho.crm.api.zia_people_enrichment.email_info import EmailInfo
...
from zohocrmsdk.src.com.zoho.crm.api.zia_people_enrichment.experience import Experience
from zohocrmsdk.src.com.zoho.crm.api.zia_people_enrichment.industry import Industry
...
from zohocrmsdk.src.com.zoho.crm.api.zia_people_enrichment.social_media import SocialMedia
from zohocrmsdk.src.com.zoho.crm.api.zia_people_enrichment.zia_people_enrichment import ZiaPeopleEnrichment
from zohocrmsdk.src.com.zoho.crm.api.util.api_response import APIResponse


class GetZiaPeopleEnrichment:
    @staticmethod
    def get_zia_people_enrichment(ziapeople_enrichment_id):
        zia_people_enrichment_operations = ZiaPeopleEnrichmentOperations()
        response = zia_people_enrichment_operations.get_zia_people_enrichment(ziapeople_enrichment_id)
        ...
        if response:
            ...
            if isinstance(response_handler, ResponseWrapper):
                ...
                ziapeople_enrichment_list = response_wrapper.get_ziapeopleenrichment()

                if ziapeople_enrichment_list:
                    for ziapeople_enrichment in ziapeople_enrichment_list:
                        enriched_data = ziapeople_enrichment.get_enriched_data()
                        ...
                        enrich_based_on = ziapeople_enrichment.get_enrich_based_on()
                        if enrich_based_on:
                        ...
                        print("zia_people_enrichment Id: " + str(ziapeople_enrichment.get_id()))
                        print("zia_people_enrichment Status: " + ziapeople_enrichment.get_status())
...
zia_people_enrichment_id = 727200561001
GetZiaPeopleEnrichment.initialize()
GetZiaPeopleEnrichment.get_zia_people_enrichment(zia_people_enrichment_id)