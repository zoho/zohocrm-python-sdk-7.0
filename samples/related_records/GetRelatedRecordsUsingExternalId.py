...
from zohocrmsdk.src.com.zoho.crm.api.related_records import RelatedRecordsOperations, GetRelatedRecordsParam, ResponseWrapper, APIException, GetRelatedRecordsUsingExternalIDHeader
...
class GetRelatedRecordsUsingExternalId:
    ...
    def get_related_records_using_external_id(module_api_name, external_value, related_list_api_name):
        ...
        header_instance.add(GetRelatedRecordsUsingExternalIDHeader.if_modified_since, datetime.fromisoformat('2019-10-15T05:00:00+05:30'))
