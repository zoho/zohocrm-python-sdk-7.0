...
from zohocrmsdk.src.com.zoho.crm.api.related_records import RelatedRecordsOperations, DelinkRecordsParam, ActionWrapper, \
    SuccessResponse, DeleteRelatedRecordsUsingExternalIDHeader,APIException
...
class DeleteRelatedRecordsUsingExternalId:
    ...
    def delete_related_records_using_external_id(module_api_name, external_value, related_list_api_name, related_list_ids):
        ...
        response = related_records_operations.delete_related_records_using_external_id(external_value, param_instance, header_instance)
