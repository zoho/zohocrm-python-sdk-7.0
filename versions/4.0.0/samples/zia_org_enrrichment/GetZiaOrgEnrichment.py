...
from zohocrmsdk.src.com.zoho.crm.api.zia_org_enrichment.address import Address
from zohocrmsdk.src.com.zoho.crm.api.zia_org_enrichment.description import Description
...
from zohocrmsdk.src.com.zoho.crm.api.zia_org_enrichment.industry import Industry
...
from zohocrmsdk.src.com.zoho.crm.api.zia_org_enrichment.zia_org_enrichment import ZiaOrgEnrichment
from zohocrmsdk.src.com.zoho.crm.api.zia_org_enrichment.social_media import SocialMedia
    ...
    def get_zia_org_enrichment(zia_org_enrichment_id):
        ...
        if response is not None:
            ...
            if isinstance(response_handler, ResponseWrapper):
                ...
                zia_org_enrichment_list = response_wrapper.get_ziaorgenrichment()
                ...
                if zia_org_enrichment_list:
                    for zia_org_enrichment in zia_org_enrichment_list:
                        ...
                        if enriched_data:
                            ...
                            print(
                                f"zia_org_enrichment EnrichedData SecondaryEmail : {enriched_data.get_secondary_email()}")
                            print(f"zia_org_enrichment EnrichedData Revenue : {enriched_data.get_revenue()}")
                            print(
                                f"zia_org_enrichment EnrichedData YearsInIndustry : {enriched_data.get_years_in_industry()}")
                            ...
                            print(
                                f"zia_org_enrichment EnrichedData TechnoGraphicData : {enriched_data.get_techno_graphic_data()}")
                            print(f"zia_org_enrichment EnrichedData Logo : {enriched_data.get_logo()}")
                            print(
                                f"zia_org_enrichment EnrichedData SecondaryContact : {enriched_data.get_secondary_contact()}")
                            ...
                            if addresses:
                                for address in addresses:
                                    ...
                                    print(
                                        f"zia_org_enrichment EnrichedData Address FillAddress : {address.get_fill_address()}")
                            ...
                            if head_quarters:
                                for head_quarter in head_quarters:
                                    print(
                                        f"zia_org_enrichment EnrichedData HeadQuarters Country : {head_quarter.get_country()}")
                                    print(
                                        f"zia_org_enrichment EnrichedData HeadQuarters City : {head_quarter.get_city()}")
                                    print(
                                        f"zia_org_enrichment EnrichedData HeadQuarters PinCode : {head_quarter.get_pin_code()}")
                                    print(
                                        f"zia_org_enrichment EnrichedData HeadQuarters State : {head_quarter.get_state()}")
                                    print(
                                        f"zia_org_enrichment EnrichedData HeadQuarters FillAddress : {head_quarter.get_fill_address()}")

                            print(
                                f"zia_org_enrichment EnrichedData NoOfEmployees : {enriched_data.get_no_of_employees()}")
                            ...
                            if industries:
                                for industry in industries:
                                    ...
                                    print(
                                        f"zia_org_enrichment EnrichedData Industries Description : {industry.get_description()}")
                            ...
                            print(
                                f"zia_org_enrichment EnrichedData PrimaryContact : {enriched_data.get_primary_contact()}")

                            social_media = enriched_data.get_social_media()
                            if social_media:
                                for media in social_media:
                                    print(
                                        f"zia_org_enrichment EnrichedData SocialMedia MediaType : {media.get_media_type()}")
...
zia_org_enrichment_id = 72722561001
GetZiaOrgEnrichment.initialize()
GetZiaOrgEnrichment.get_zia_org_enrichment(zia_org_enrichment_id)
