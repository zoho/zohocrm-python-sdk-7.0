...
class SectionField(Fields):
	...
	def get_auto_number_70(self):
		...
		return self.__auto_number_70

	def set_auto_number_70(self, auto_number_70):
		"""
		The method to set the value to auto_number_70

		Parameters:
			auto_number_70 (AutoNumber) : An instance of AutoNumber
		"""
		...
		if auto_number_70 is not None and not isinstance(auto_number_70, AutoNumber):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: auto_number_70 EXPECTED TYPE: AutoNumber', None, None)
		
		self.__auto_number_70 = auto_number_70
