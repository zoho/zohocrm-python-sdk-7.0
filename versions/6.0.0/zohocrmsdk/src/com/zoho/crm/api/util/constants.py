...
class Constants(object):
    ...
    SET_CONTENT_TYPE_HEADER = ["/crm/bulk/v7/read", "/crm/bulk/v7/write", "/crm/v7/__zia_org_enrichment", "crm/v7/__zia_people_enrichment", "/crm/v7/settings/audit_log_export"]
