...
class CreateZiaPeopleEnrichment:
    ...
    def create_zia_people_enrichment():
        ...
        ziapeopleenrichment1 = ZiaPeopleEnrichment()
        ...
        ziapeopleenrichment1.set_enrich_based_on(enrich_based_on)
        zia_people_enrichment.append(ziapeopleenrichment1)
        request.set_ziapeopleenrichment(zia_people_enrichment)
        ...
        if response is not None:
            ...
            if isinstance(action_handler, ActionWrapper):
                ...
                action_responses = action_wrapper.get_ziapeopleenrichment()
